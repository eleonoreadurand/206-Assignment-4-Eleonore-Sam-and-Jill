...
figure2 <- ggplot(stats, aes(x = reach, y = Mean)) +
  ...
  labs(y=expression(Mean~Sediment~Bulk~Density~(g/cm^{"3"}))) +
  scale_x_discrete(labels = c("Reach A","Reach B","Reach C","Reach D")) +
  xlab("\nRiver Reach") +
  geom_signif(y_position = c(1.0, 1.2), xmin = c(1,1), xmax = c(2,3), annotation = c("p = 0.032","p = 0.046"), tip_length = 0.1, size = 0.5, textsize = 3) +
